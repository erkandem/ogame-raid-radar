...
class Building:
    ...
    def __init__(self, *, level, consumption_factor, production_factor):
...
class DeuteriumSynthesizer(Building):
    def __init__(self, *, t_max_planet, level, acceleration: int = 1):
        super().__init__(production_factor=20, consumption_factor=10, level=level)
...
class SolarPlant(Building):
    def __init__(self, level, etech_level=None, acceleration=1):
